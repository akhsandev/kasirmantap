                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                            ...
                            <div className="mt-2"><label className="text-[10px] font-bold text-slate-400">3. Hasil URL</label><input value={qrisImage} onChange={e => setQrisImage(e.target.value)} className="w-full border p-2 rounded text-xs bg-slate-100 text-slate-500" readOnly /></div>
